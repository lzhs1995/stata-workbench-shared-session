...
if (Sentry && Sentry.init) {
    Sentry.init({
        ...
        release: typeof globalThis.__SENTRY_RELEASE__ === 'string'
...
const { getVariablesFromResponse } = require('../../scripts/data_browser_response_core.js');
...
function initBrowser(baseUrl, token) {
    ...
    apiCall('/v1/dataset', 'GET')
        ...
        .then(response => {
            const variables = getVariablesFromResponse(response);
